import { edited, requestQuickFixes, requestCompletions, executeCommand, telemetryEvent, telemetryCrash, registerBreakpoints } from './run.js';
import * as __wbg_star0 from './run.js';
...
function __wbg_adapter_52(arg0, arg1) {
    const ret = wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h47e958895d8c4a7e_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
const LilypadWebHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_lilypadwebhandle_free(ptr >>> 0, 1));

export class LilypadWebHandle {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        LilypadWebHandleFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_lilypadwebhandle_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.lilypadwebhandle_new();
        this.__wbg_ptr = ret >>> 0;
        LilypadWebHandleFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @param {string} blocks_theme
     * @returns {Promise<void>}
     */
    start(canvas_id, file_name, font_name, font_size, blocks_theme) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(font_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(blocks_theme, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.lilypadwebhandle_start(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, font_size, ptr3, len3);
        return ret;
    }
    /**
     * @param {string} text
    ...
    set_text(text) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.lilypadwebhandle_set_text(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} file_name
     */
    set_file(file_name) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.lilypadwebhandle_set_file(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} font_name
     * @param {number} font_size
    ...
    set_font(font_name, font_size) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.lilypadwebhandle_set_font(this.__wbg_ptr, ptr0, len0, font_size);
    }
    /**
     * @param {any} json
     */
    apply_edit(json) {
        wasm.lilypadwebhandle_apply_edit(this.__wbg_ptr, json);
    }
    /**
     * @param {string} theme
     */
    set_blocks_theme(theme) {
        const ptr0 = passStringToWasm0(theme, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.lilypadwebhandle_set_blocks_theme(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {any} json
     */
    set_diagnostics(json) {
        wasm.lilypadwebhandle_set_diagnostics(this.__wbg_ptr, json);
    }
    /**
     * @param {number} id
     * @param {any} fixes_json
     */
    set_quick_fixes(id, fixes_json) {
        wasm.lilypadwebhandle_set_quick_fixes(this.__wbg_ptr, id, fixes_json);
    }
    /**
     * @param {any} json
     */
    set_completions(json) {
        wasm.lilypadwebhandle_set_completions(this.__wbg_ptr, json);
    }
    /**
     * @param {any} json
     */
    set_breakpoints(json) {
        wasm.lilypadwebhandle_set_breakpoints(this.__wbg_ptr, json);
    }
    /**
     * @param {number | undefined} [selected]
     * @param {number | undefined} [deepest]
     */
    set_stack_frame(selected, deepest) {
        wasm.lilypadwebhandle_set_stack_frame(this.__wbg_ptr, !isLikeNone(selected), isLikeNone(selected) ? 0 : selected, !isLikeNone(deepest), isLikeNone(deepest) ? 0 : deepest);
    }
    undo() {
        wasm.lilypadwebhandle_undo(this.__wbg_ptr);
    }
    redo() {
        wasm.lilypadwebhandle_redo(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_requestQuickFixes_5721f2c51a8e8fce = function(arg0, arg1, arg2) {
        requestQuickFixes(arg0 >>> 0, arg1 >>> 0, arg2 >>> 0);
    };
    ...
    imports.wbg.__wbg_registerBreakpoints_bc2a9800441171a5 = function(arg0, arg1) {
        var v0 = getArrayU32FromWasm0(arg0, arg1).slice();
        wasm.__wbindgen_free(arg0, arg1 * 4, 4);
        registerBreakpoints(v0);
    };
    ...
    imports.wbg.__wbg_telemetryEvent_1afdf7236452d23b = function(arg0, arg1, arg2) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            telemetryEvent(getStringFromWasm0(arg0, arg1), arg2);
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    imports.wbg.__wbg_edited_bffbdc7a0b619ceb = function(arg0, arg1, arg2, arg3, arg4, arg5) {
        edited(getStringFromWasm0(arg0, arg1), arg2 >>> 0, arg3 >>> 0, arg4 >>> 0, arg5 >>> 0);
    };
    imports.wbg.__wbg_requestCompletions_1d6b93d9055c97ab = function(arg0, arg1) {
        requestCompletions(arg0 >>> 0, arg1 >>> 0);
    };
    imports.wbg.__wbg_executeCommand_c46fea55c79cdf5c = function(arg0, arg1, arg2) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            executeCommand(getStringFromWasm0(arg0, arg1), arg2);
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    imports.wbg.__wbg_telemetryCrash_874ac0e5f54f9d74 = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            telemetryCrash(getStringFromWasm0(arg0, arg1));
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper1165 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 248, __wbg_adapter_55);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper1181 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 256, __wbg_adapter_60);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('lilypad_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
